...
func level1() -> Level {
    ...
    var level = Level(size: ISize(width: 100, height: 100), walls:[], enemies:[], spawn: IVector(x: 2, y: 2), exit: IRect(point1: IVector(x: 45, y: 45), point2: IVector(x: 50, y: 50)))
    
    level.walls = [ILineSeg(point1: IVector(x: 5, y: 0), point2: IVector(x: 5, y: 10)),
                   ILineSeg(point1: IVector(x: 5, y: 10), point2: IVector(x: 25, y: 10)),
                   ILineSeg(point1: IVector(x: 5, y: 15), point2: IVector(x: 25, y: 15)),
                   ILineSeg(point1: IVector(x: 25, y: 10), point2: IVector(x: 25, y: 15)),
                   ...
                   ILineSeg(point1: IVector(x: 35, y: 7), point2: IVector(x: 25, y: 7)),
