...
func level1() -> Level {
    ...
    level.walls = [ILineSeg(point1: IVector(x: 5, y: 0), point2: IVector(x: 5, y: 10)),
                   ...
                   ILineSeg(point1: IVector(x: 45, y: 30), point2: IVector(x: 40, y: 35)),
                   ILineSeg(point1: IVector(x: 30, y: 30), point2: IVector(x: 45, y: 35)),
                   ILineSeg(point1: IVector(x: 40, y: 35), point2: IVector(x: 35, y: 35)),
